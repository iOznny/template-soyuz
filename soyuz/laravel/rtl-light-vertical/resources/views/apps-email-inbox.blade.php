                    ...
                    <div class="card-body">
                        <ul class="list-group pr-0">
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                <a href="{{url('/apps-email-inbox')}}" class="active">Inbox<i class="feather icon-inbox ml-2"></i></a>
                            <span class="badge badge-primary-inverse text-primary">9</span>
                            </li>
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                <a href="#">Starred<i class="feather icon-star ml-2"></i></a>
                            <span class="badge badge-secondary-inverse">2</span>                                        
                            </li>
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                <a href="#">Snoozed<i class="feather icon-clock ml-2"></i></a>
                            <span class="badge badge-secondary-inverse">3</span>                                        
                            </li>
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                <a href="#">Sent<i class="feather icon-send ml-2"></i></a>
                            <span class="badge badge-secondary-inverse">4</span>                                        
                            </li>
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                <a href="#">Drafts<i class="feather icon-file ml-2"></i></a>
                            <span class="badge badge-secondary-inverse">5</span>
                            </li>
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                <a href="#">Important<i class="feather icon-award ml-2"></i></a>
                            <span class="badge badge-secondary-inverse">6</span>
                            </li>
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                <a href="#">Spam<i class="feather icon-alert-octagon ml-2"></i></a>
                            <span class="badge badge-secondary-inverse">7</span>
                            </li>
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                <a href="#">Trash<i class="feather icon-trash ml-2"></i></a>
                ...
                <div class="card m-b-30">
                    <div class="card-header">
                        <ul class="list-inline mb-0 pr-0">
                            ...
                            <li class="list-inline-item float-left"><a href="#"><i class="feather icon-settings font-20"></i></a></li>
                        </ul>
                    </div>
                    <div class="card-body">                                    
                    ...
                    <div class="card-footer">
                        <div class="row">
                            ...
                            <div class="col-6 col-md-6 align-self-center">
                                <div class="email-pagination float-left">
