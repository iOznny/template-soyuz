    ...
    <div class="row">
        ...
        <div class="col-lg-12 col-xl-3">
            <div class="card m-b-30">
                ...
                <div class="card-body">                                
                    <div class="media">
                        <img class="align-self-center ml-3 rounded-circle" src="assets/images/users/boy.svg" alt="Generic placeholder image">
                    ...
                    <div class="surgery-list">
                        <p>Abdominal <span class="float-left">80%</span></p>
                        <div class="progress mb-4" style="height: 5px;">
                          <div class="progress-bar" role="progressbar" style="width: 80%;" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                        <p>Apendix <span class="float-left">45%</span></p>
                        <div class="progress mb-4" style="height: 5px;">
                          <div class="progress-bar bg-success" role="progressbar" style="width: 45%;" aria-valuenow="45" aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                        <p>Stomach <span class="float-left">60%</span></p>
                        <div class="progress mb-4" style="height: 5px;">
                          <div class="progress-bar bg-warning" role="progressbar" style="width: 60%;" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                        <p>Kidney <span class="float-left">35%</span></p>
                        <div class="progress mb-4" style="height: 5px;">
                          <div class="progress-bar bg-danger" role="progressbar" style="width: 35%;" aria-valuenow="35" aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                        <p>Liver <span class="float-left">25%</span></p>
                        <div class="progress mb-4" style="height: 5px;">
                    ...
                    <div class="card m-b-30">
                        <div class="card-header">                                
                            <div class="row align-items-center">
                                ...
                                <div class="col-3">
                                     <button type="button" class="btn btn-outline-primary btn-sm float-left font-12">Export</button>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card m-b-30">
                        <div class="card-header">                                
                            <div class="row align-items-center">
                                ...
                                <div class="col-3">
                                    <div class="dropdown">
                                        <button class="btn btn-link p-0 font-18 float-left" type="button" id="patientAge" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="feather icon-more-horizontal-"></i></button>
                                        <div class="dropdown-menu dropdown-menu-left" aria-labelledby="patientAge">
                    ...
                    <div class="card m-b-30">
                        <div class="card-header">                                
                            <div class="row align-items-center">
                                ...
                                <div class="col-3">
                                    <div class="dropdown">
                                        <button class="btn btn-link p-0 font-18 float-left" type="button" id="statsDepart" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="feather icon-more-horizontal-"></i></button>
                                        <div class="dropdown-menu dropdown-menu-left" aria-labelledby="statsDepart">
                                            <a class="dropdown-item font-13" href="#">Refresh</a>
                                            <a class="dropdown-item font-13" href="#">Export</a>
                                        </div>
                                    </div>
