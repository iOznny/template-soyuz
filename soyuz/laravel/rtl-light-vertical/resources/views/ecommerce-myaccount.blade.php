            ...
            <div class="card m-b-30">
                ...
                <div class="card-body">
                    <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                        <a class="nav-link mb-2 active" id="v-pills-dashboard-tab" data-toggle="pill" href="#v-pills-dashboard" role="tab" aria-controls="v-pills-dashboard" aria-selected="true">Dashboard<i class="feather icon-grid ml-2"></i></a>
                        <a class="nav-link mb-2" id="v-pills-order-tab" data-toggle="pill" href="#v-pills-order" role="tab" aria-controls="v-pills-order" aria-selected="false">My Orders<i class="feather icon-package ml-2"></i></a>
                        <a class="nav-link mb-2" id="v-pills-addresses-tab" data-toggle="pill" href="#v-pills-addresses" role="tab" aria-controls="v-pills-addresses" aria-selected="false">My Addresses<i class="feather icon-map-pin ml-2"></i></a>
                        <a class="nav-link mb-2" id="v-pills-wishlist-tab" data-toggle="pill" href="#v-pills-wishlist" role="tab" aria-controls="v-pills-wishlist" aria-selected="false">Wishlist<i class="feather icon-heart ml-2"></i></a>
                        <a class="nav-link mb-2" id="v-pills-wallet-tab" data-toggle="pill" href="#v-pills-wallet" role="tab" aria-controls="v-pills-wallet" aria-selected="true">Wallet<i class="feather icon-credit-card ml-2"></i></a>
                        <a class="nav-link mb-2" id="v-pills-chat-tab" data-toggle="pill" href="#v-pills-chat" role="tab" aria-controls="v-pills-chat" aria-selected="false">My Chat<i class="feather icon-message-circle ml-2"></i></a>
                        <a class="nav-link mb-2" id="v-pills-notifications-tab" data-toggle="pill" href="#v-pills-notifications" role="tab" aria-controls="v-pills-notifications" aria-selected="false">Notifications<i class="feather icon-bell ml-2"></i></a>
                        <a class="nav-link mb-2" id="v-pills-profile-tab" data-toggle="pill" href="#v-pills-profile" role="tab" aria-controls="v-pills-profile" aria-selected="false">My Profile<i class="feather icon-user ml-2"></i></a>
                        <a class="nav-link" id="v-pills-logout-tab" data-toggle="pill" href="#v-pills-logout" role="tab" aria-controls="v-pills-logout" aria-selected="false">Logout<i class="feather icon-log-out ml-2"></i></a>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="card-body">
                            <div class="ecom-notification-box">
                                <ul class="list-unstyled pr-0">
                                    <li class="media">
                                        <span class="ml-3 action-icon badge badge-dark-inverse"><i class="feather icon-box"></i></span>
                                        <div class="media-body">
                                    ...
                                    <li class="media">
                                        <span class="ml-3 action-icon badge badge-dark-inverse"><i class="feather icon-percent"></i></span>
                                        <div class="media-body">
                                    ...
                                    <li class="media">
                                        <span class="ml-3 action-icon badge badge-dark-inverse"><i class="feather icon-alert-octagon"></i></span>
                                        <div class="media-body">
                                    ...
                                    <li class="media">
                                        <span class="ml-3 action-icon badge badge-dark-inverse"><i class="feather icon-dollar-sign"></i></span>
                                        <div class="media-body">
