                ...
                <div class="col-lg-12 col-xl-4">
                    <div class="card m-b-30">
                        <div class="card-body">
                            <div class="row align-items-center">
                                <div class="col-7">
                                    <h4><i class="feather icon-arrow-up text-success mr-1"></i>$985</h4>
                ...
                <div class="col-lg-12 col-xl-4">
                    <div class="card m-b-30">
                        <div class="card-body">
                            <div class="row align-items-center">
                                <div class="col-7">
                                    <h4><i class="feather icon-arrow-down text-danger mr-1"></i>542</h4>
                ...
                <div class="col-lg-12 col-xl-4">
                    <div class="card m-b-30">
                        <div class="card-body">
                            <div class="row align-items-center">
                                <div class="col-7">
                                    <h4><i class="feather icon-arrow-up text-success mr-1"></i>253</h4>
                    ...
                    <div class="card m-b-30">
                        <div class="card-header">                                
                            <div class="row align-items-center">
                                ...
                                <div class="col-3">
                                    <div class="dropdown">
                                        <button class="btn btn-link p-0 font-18 float-left" type="button" id="newLeads" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="feather icon-more-horizontal-"></i></button>
                                        <div class="dropdown-menu dropdown-menu-left" aria-labelledby="newLeads">
                    ...
                    <div class="card m-b-30">
                        <div class="card-header">                                
                            <div class="row align-items-center">
                                ...
                                <div class="col-3">
                                    <div class="dropdown">
                                        <button class="btn btn-link p-0 font-18 float-left" type="button" id="ticketStatus" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="feather icon-more-horizontal-"></i></button>
                                        <div class="dropdown-menu dropdown-menu-left" aria-labelledby="ticketStatus">
                                            <a class="dropdown-item font-13" href="#">Refresh</a>
                                            <a class="dropdown-item font-13" href="#">Export</a>
                                        </div>
                                    </div>
                            ...
                            <div class="row align-items-center">
                                <div class="col-12 col-sm-5 p-0">
                                    <div class="nav flex-column nav-pills" id="v-pills-ticket-tab" role="tablist" aria-orientation="vertical">
                                        <a class="nav-link active" id="v-pills-support-tab" data-toggle="pill" href="#v-pills-support" role="tab" aria-controls="v-pills-support" aria-selected="true">Support<i class="feather icon-circle font-12 ml-1"></i><span class="float-left font-14 text-muted">50</span></a>
                                        <a class="nav-link" id="v-pills-sales-tab" data-toggle="pill" href="#v-pills-sales" role="tab" aria-controls="v-pills-sales" aria-selected="false">Sales<i class="feather icon-circle font-12 ml-1"></i><span class="float-left font-14 text-muted">65</span></a>
                                        <a class="nav-link" id="v-pills-product-tab" data-toggle="pill" href="#v-pills-product" role="tab" aria-controls="v-pills-product" aria-selected="false">Product<i class="feather icon-circle font-12 ml-1"></i><span class="float-left font-14 text-muted">85</span></a>
                                        <a class="nav-link" id="v-pills-hiring-tab" data-toggle="pill" href="#v-pills-hiring" role="tab" aria-controls="v-pills-hiring" aria-selected="false">Hiring<i class="feather icon-circle font-12 ml-1"></i><span class="float-left font-14 text-muted">32</span></a>
                                    </div>
                                </div>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-3">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-left" aria-labelledby="widgetRevenue">
                                    <a class="dropdown-item font-13" href="#">Refresh</a>
                                    <a class="dropdown-item font-13" href="#">Export</a>
                                </div>
                            </div>
            ...
            <div class="card m-b-30">
                <div class="card-header">                                
                    <div class="row align-items-center">
                        ...
                        <div class="col-3">
                            <div class="dropdown">
                                <button class="btn btn-link p-0 font-18 float-left" type="button" id="upcomingTask" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="feather icon-more-horizontal-"></i></button>
                                <div class="dropdown-menu dropdown-menu-left" aria-labelledby="upcomingTask">
                                    <a class="dropdown-item font-13" href="#">Refresh</a>
                                    <a class="dropdown-item font-13" href="#">Export</a>
                                </div>
                            </div>
            ...
            <div class="card m-b-30">
                <div class="card-header">                                
                    <div class="row align-items-center">
                        ...
                        <div class="col-3">
                            <div class="dropdown">
                                <button class="btn btn-link p-0 font-18 float-left" type="button" id="earningCountry" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="feather icon-more-horizontal-"></i></button>
                                <div class="dropdown-menu dropdown-menu-left" aria-labelledby="earningCountry">
                                    <a class="dropdown-item font-13" href="#">Refresh</a>
                                    <a class="dropdown-item font-13" href="#">Export</a>
                                </div>
                            </div>
