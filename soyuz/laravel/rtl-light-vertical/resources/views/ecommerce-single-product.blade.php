                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-xl-7">
                            <p><span class="badge badge-light font-16">Appliances</span></p>
                            <h2 class="font-22">Electronic Kettle</h2>
                            <p>
                ...
                <div class="card-body">
                    ...
                    <div class="row">                                    
                        ...
                        <div class="col-lg-6 col-xl-3">
                            <div class="product-bar m-b-30">
                                <div class="product-head">
                                    <a href="{{url('/ecommerce-single-product')}}l"><img src="assets/images/ecommerce/product_img_04.jpg" class="img-fluid" alt="product"></a>
                                    <p><span class="badge badge-success font-14">Sale</span></p>  
                                </div>                                            
                                <div class="product-body py-3">
                                    <div class="row align-items-center">
